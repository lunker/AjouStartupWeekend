...
public class CustomExpandAdapter extends BaseExpandableListAdapter {
    ...
    public CustomExpandAdapter(Activity context, List<String> parentList, HashMap<String, List<String>> childList) {
    ...
    public String getChild(int groupPosition, int childPosition) {
        return this.childRecord.get(((String) getGroup(groupPosition))).get(childPosition);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        try {
            if (convertView == null) {
                ...
                holder.parentTitle = (TextView) convertView.findViewById(R.id.test_left_item);
                convertView.setTag(holder);
            } else {
                holder = (ViewHolder) convertView.getTag();
            }
...
//            holder.parentIcon.setBackgroundResource(parentSampleTo.getIcon());
    ...
    public int getChildrenCount(int groupPosition) {
        return this.childRecord.get(((String) getGroup(groupPosition))).size();
    }
